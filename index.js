...
banChats = true
offline = false
ownerNumber = ["@6281252254886"]
targetpc = '60139571124'
owner = '6281252254886'
fake = 'ʜᴇʟʟᴏ\nɪ ᴀᴍ 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣'
numbernye = '0'
waktu = '-'
alasan = '-'
...
module.exports = hexa = async (hexa, mek) => {
	try {
        ...
        //MESS
		mess = {
			wait: '[❗] Bentar Bang/Mbak Masih Proses',
			success: 'Berhasil!',
...
const textImg = (teks) => {
   ...
   //FAKEREPLY PRODUCT
            const ftoko = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "60139571124@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./stik/thumb.jpeg`)},"title": `JASA KEBUTUHAN ALL SOSMED \n${pushname}`,"description": "𝙺𝙸𝚉𝙰𝙺𝙸𝚇𝙳", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "ɪ ᴀᴍ ᴢᴀᴋʙᴏᴛᴢ","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
...
*Model* : ${i.phone.device_model}\n\n`
	...
	case 'start':
        ...
        txtt =`Hai Kak ${pushname}\nPilih Opsi Dibawah Ini Ya.. `
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: '© Creator 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣 \nSupport Me Or Subscribe', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case 'menu':
    ...
    wew = fs.readFileSync(`./lib/vallgans.jpeg`)
    	var menu = `*╭─❒ 「 BOT INFO 」 ──────*
*│*➪ *NAMA : 𝙷𝚎𝚕𝚕𝚘 ${pushname} 𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝙳𝚊𝚝𝚊𝚗𝚐 𝙳𝚒 𝙱𝚘𝚝 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣*
*│*➪ *WIB    : ${timeWib}*
*│*➪ *WIT    : ${timeWit}*
*│*➪ *WITA  : ${timeWita}*
*│*➪ *CREATOR : 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣*
*│*➪ *BOT NAME : 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣*
*│*➪ *PREFIX :「 MULTI PREFIX 」*
...
*╭─❒ 「 PATNER BOTZ 」*  
*│*
*├  ⎔  : 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣*
*├  ⎔  : YakkoXCode*
*├  ⎔  : Akira*
*├  ⎔  : Origami-Bot*
*├  ⎔  : Tegar Gay*
...
buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: '👤 ORANG GANTENG'},type:1},{buttonId:`${prefix}ytadmin`,buttonText:{displayText:'⎙ NEKOPOI'},type:1},{buttonId: `${prefix}shutdown`,buttonText:{displayText: '☰ SHUTDOWN BOT'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '_*© 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 𝙹𝙰𝚂𝙰 𝙺𝙴𝙱𝚄𝚃𝚄𝙷𝙰𝙽 𝙰𝙻𝙻 𝚂𝙾𝚂𝙼𝙴𝙳 𝙱𝙾𝚃𝚣*_',
               buttons: buttons,
               headerType: 1
}
